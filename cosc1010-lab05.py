...
highestTemp, lowestTemp = 0, 0

for currTemp in max_temps:
    if currTemp > highestTemp:
        highestTemp = currTemp

for currTemp2 in min_temps:
    if lowestTemp > currTemp2:
        lowestTemp = currTemp2


print(f"Max temp = {highestTemp}")
print(f"Min temp = {lowestTemp}")
...
print(f'There are {posNums} positive numbers')
print(f'There are {negNums} negative numbers')
